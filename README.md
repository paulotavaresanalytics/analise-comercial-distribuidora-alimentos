...
Projeto desenvolvido para portfólio profissional de análise de dados, com foco em cenário comercial do setor de distribuição de alimentos.

---

Se este projeto te ajudou como inspiração para montar seu portfólio, aproveite para adaptar os dados, criar dashboards e publicar resultados visuais no GitHub.
